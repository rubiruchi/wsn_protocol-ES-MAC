...
file_name='output_bma_mac300.txt'
...
roundAxis=roundAxis[0:firstDeadNodeRound//2]+roundAxis[firstDeadNodeRound//2:6000:60]
numberOfDeadNodesAxis=numberOfDeadNodesAxis[0:firstDeadNodeRound//2]+numberOfDeadNodesAxis[firstDeadNodeRound//2:6000:60]
...
plt.text(lastDeadNodeRound-500, 300, lastDeadNodeRound)
