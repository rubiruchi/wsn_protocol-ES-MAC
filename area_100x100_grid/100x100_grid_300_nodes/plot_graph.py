...
plt.text(lastDeadNodeRound_1, 310, lastDeadNodeRound_1)
...
roundAxis_2=roundAxis_2[0:firstDeadNodeRound_2//2:10]+roundAxis_2[firstDeadNodeRound_2//2:6000:85]
numberOfDeadNodesAxis_2=numberOfDeadNodesAxis_2[0:firstDeadNodeRound_2//2:10]+numberOfDeadNodesAxis_2[firstDeadNodeRound_2//2:6000:85]
...
plt.text(firstDeadNodeRound_2-100, -15, firstDeadNodeRound_2)
plt.text(lastDeadNodeRound_2, 310, lastDeadNodeRound_2)
...
roundAxis_3=roundAxis_3[0:firstDeadNodeRound_3//2]+roundAxis_3[firstDeadNodeRound_3//2:6000:100]
numberOfDeadNodesAxis_3=numberOfDeadNodesAxis_3[0:firstDeadNodeRound_3//2]+numberOfDeadNodesAxis_3[firstDeadNodeRound_3//2:6000:100]
...
plt.text(lastDeadNodeRound_3, 285, lastDeadNodeRound_3)
