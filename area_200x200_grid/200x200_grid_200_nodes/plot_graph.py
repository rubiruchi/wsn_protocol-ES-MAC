...
roundAxis_1=roundAxis_1[0:firstDeadNodeRound_1//2]+roundAxis_1[firstDeadNodeRound_1//2:6000:55]
numberOfDeadNodesAxis_1=numberOfDeadNodesAxis_1[0:firstDeadNodeRound_1//2]+numberOfDeadNodesAxis_1[firstDeadNodeRound_1//2:6000:55]
...
plt.text(firstDeadNodeRound_1-300, 10, firstDeadNodeRound_1)
plt.text(lastDeadNodeRound_1, 210, lastDeadNodeRound_1)
...
roundAxis_2=roundAxis_2[0:firstDeadNodeRound_2//2]+roundAxis_2[firstDeadNodeRound_2//2:6000:75]
numberOfDeadNodesAxis_2=numberOfDeadNodesAxis_2[0:firstDeadNodeRound_2//2]+numberOfDeadNodesAxis_2[firstDeadNodeRound_2//2:6000:75]
...
plt.text(firstDeadNodeRound_2-100, -10, firstDeadNodeRound_2)
plt.text(lastDeadNodeRound_2, 210, lastDeadNodeRound_2)
...
roundAxis_3=roundAxis_3[0:firstDeadNodeRound_3//2]+roundAxis_3[firstDeadNodeRound_3//2:6000:90]
numberOfDeadNodesAxis_3=numberOfDeadNodesAxis_3[0:firstDeadNodeRound_3//2]+numberOfDeadNodesAxis_3[firstDeadNodeRound_3//2:6000:90]
...
plt.text(lastDeadNodeRound_3, 190, lastDeadNodeRound_3)
